...
#' @param ukdata Demographic data needed to define the intervention ODEs
...
make_RunInterventions <- function(RunInterventions, ukdata, data_inter_uk, run_burn, run_full) {
    classRunInterventions <- new(RunInterventions, ukdata$numberDailyLiveBirths, ukdata$population, ukdata$ageGroupBoundary) # Calls class
